...
The Kruskal-Wallis test for Attack Points across types yielded a p-value of `r gtsummary::inline_text(tbl_des, variable = "attack", column = "p.value")`, suggesting `r ifelse(gtsummary::inline_text(tbl_des, variable = "attack", column = "p.value") < 0.05, "a statistically significant", "no statistically significant")` difference across primary types.
